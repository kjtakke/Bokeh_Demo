...
tab1 = Panel(child=p1, title="Bar 1 colour")
tab2 = Panel(child=p2, title="Bar multi colour")
tab3 = Panel(child=p3, title="Stacked bar")
tab4 = Panel(child=p4, title="Line Plot")
